...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>Sky Mote Lab1 Master #master</description>
      <source EXPORT="discard">[CONTIKI_DIR]/own projects/Lab 1/master.c</source>
      <commands EXPORT="discard">make master.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/own projects/Lab 1/master.sky</firmware>
    ...
    <motetype>
      ...
      <description>Sky Mote Lab1 Slave #slave</description>
      <source EXPORT="discard">[CONTIKI_DIR]/own projects/Lab 1/slave.c</source>
      <commands EXPORT="discard">make slave.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/own projects/Lab 1/slave.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>18.75014325046157</x>
        <y>46.748101622186084</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>master</motetype_identifier>
    </mote>
    <mote>
      <breakpoints />
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>50.026673365419974</x>
        <y>15.4912402008379</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-9.111164577922832</x>
        <y>14.640983344236826</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-12.273499965418855</x>
        <y>77.63226990762662</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>45.93219942743973</x>
        <y>78.92445242904998</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
